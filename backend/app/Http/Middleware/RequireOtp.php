...
class RequireOtp
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($user === null || ! $user->otp_enabled || $request->routeIs(self::ALLOWED)) {
            return $next($request);
        }
         ...
         * rule — the login form, a "remember me" cookie being honoured, a
         * session that was authenticated before this factor was switched on.
         * Hooking the login event instead would have left the last two walking
         * straight past a screen that was never shown.
         */
